...
class _AccountScreenState extends State<AccountScreen> {
  ...
  Future<void> _loadUserData() async {
    final response = await http.get(
      Uri.parse('http://192.168.1.102:5014/api/Users/${widget.userId}'),
    );
  ...
  Future<void> _pickAndUploadImage() async {
    ...
    final request = http.MultipartRequest(
      'POST',
      Uri.parse(
        'http://192.168.1.102:5014/api/Users/${widget.userId}/upload-image',
      ),
    );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text("Account info", style: TextStyle(color: Colors.pink)),
        centerTitle: true,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildSectionButton("My orders", Icons.shopping_bag),
